            ...
            974: () => {
                layui.define(["form", "layer", "table", "common", "treeTable"], (function(t) {
                    ...
                    var e, a, n, i, l, o = layui.form,
                        ...
                        m = !1,
                        p = {
                            tableIns: function(t, o, d = null, p = "", b = !1) {
                                a = o, n = d, p && "" != p || (p = cUrl + "/list");
                                var y = s("#param").val();
                                if (y && (y = JSON.parse(y), s.isArray(y)))
                                    for (var v in y) p.indexOf("?") >= 0 ? p += "&" + y[v] : p += "?" + y[v];
                                return e = r.render({
                                    elem: "#" + a,
                                    url: p,
                                    method: "post",
                                    ...
                                    loading: !0,
                                        ...
                                        if (l) {
                                            ...
                                            n.children("tr").on("dblclick", (function() {
                                                var e = n.find(".layui-table-hover").data("index"),
                                                    a = t.data[e];
                                                u.edit(i, a.id, f, h)
                                            }))
                                        }
                                    ...
                                    }), m) : "detail" === a ? u.detail_mx(i, e.id, f, h, [], (function(t, e) {
                                        2 == e && s(".layui-laypage-btn").click()
                                    }), m): "audit" === a ? u.audit(e.id, (function(e, a) {
                                        a && t.audit()
                                    }), m): "chain_upload" === a ? u.chain_upload(e.id, (function(e, a) {
                                        a && t.chain_upload()
                                    })): "del" === a ? u.delete(e.id, (function(e, a) {
                                        a && t.del()
                                    })) : "cache" === a ? u.cache(e.id) : "copy" === a ? u.copy(i, e.id, f, h) : n && n(a, e)
                                })), r.on("checkbox(" + a + ")", (function(t) {})), r.on("edit(" + a + ")", (function(t) {
                                    var e = t.value,
                                        a = t.data,
                                        n = t.field,
                                        i = {};
                                    ...
                                    var l = JSON.stringify(i),
                                        o = JSON.parse(l),
                                        r = cUrl + "/update";
                                    u.ajaxPost(r, o, (function(t, e) {}), "更新中...")
                            ...
                            treetable: function(t = [], e, n = !0, l = 0, o = "", r = null, m = "") {
                                a = e, m || (m = cUrl + "/list");
                                var p = d.render({
                                    elem: "#" + e,
                                    url: m,
                                ...
                                d.on("tool(" + e + ")", (function(t) {
                                   ...
                                   "add" === a ? u.edit(i, 0, f, h, ["pid=" + n], (function(t, e) {
                                        ...
                                        a && t.del()
                                   })) : "chain_upload" === a ? u.chain_upload(n, (function(e, a) {
                                       a && t.chain_upload()
                                    })) : "audit" === a ? u.audit(n, (function(e, a) {
                                        a && t.audit()
                                    })):"outstock" === a ? u.outstock(n, (function(e, a) {
                                       a && t.audit()
                                   })): r && r(a, n, 0)
                            ...
                            showWin: function(t, e, a = 0, n = 0, i = [], l = 2, o = [], r = null, c = !1) {
                                u.showWin(t, e, a, n, i, l, o, (function(t, e) {
                                    r && r(t, e)
                                }), c)
                            },
                            ...
                            uploadFile: function(t, e = null, a = "", n = "xls|xlsx", i = 10240, l = {}) {
                    ...
                    u.verify(), o.on("submit(submitForm)", (function(t) {
                        ...
                        switch (s(this).attr("lay-event")) {
                            ...
                            case "dall":
                                (l = {
                                    title: "批量删除"
                                }).url = cUrl + "/delete", l.data = t, l.confirm = !0, l.type = "POST", u.batchFunc(l, (function() {
                                    e.reload()
                                }));
                                break;
                            case "batchCache":
                                (l = {
                                    title: "批量重置缓存"
                                }).url = cUrl + "/batchCache", l.data = t, l.confirm = !0, l.type = "GET", u.batchFunc(l, (function() {
                                    e.reload()
                                }));
                                break;
                            case "batchEnable":
                                (l = {
                                    title: "批量启用状态"
                                }).url = cUrl + "/batchStatus", l.param = n, l.data = t, l.form = "submitForm", l.confirm = !0, l.show_tips = "处理中...", l.type = "POST", u.batchFunc(l, (function() {
                                    e.reload()
                                }));
                                break;
                            case "batchDisable":
                                (l = {
                                    title: "批量禁用状态"
                                }).url = cUrl + "/batchStatus", l.param = n, l.data = t, l.confirm = !0, l.show_tips = "处理中...", l.type = "POST", u.batchFunc(l, (function() {
                                    e.reload()
                                }));
                                break;
                            case "export":
                                var n = [],
                                    l = s(".layui-form-item [name]").serializeArray();
                                s.each(l, (function() {
                                    n.push(this.name + "=" + this.value)
                                })), (l = {
                                    title: "导出数据"
                                }).url = cUrl + "/export", l.data = t, l.confirm = !0, l.type = "POST", l.show_tips = "数据准备中...", l.param = n, u.batchFunc(l, (function(t, e) {
