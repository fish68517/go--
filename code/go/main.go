...
import (
	...
	"github.com/mwqnice/oh-admin/internal/routers"
	"github.com/mwqnice/oh-admin/pkg/logger"
	"github.com/mwqnice/oh-admin/pkg/logger/writer"
	"github.com/mwqnice/oh-admin/pkg/setting"
	"github.com/mwqnice/oh-admin/pkg/tracer"
...
func setupFlag() error {
	...
	flag.StringVar(&config, "config", "configs/dev/", "指定要使用的配置文件路径")
