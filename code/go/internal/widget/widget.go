...
func Audit(text string) template.HTML {
	return template.HTML("<a class=\"layui-btn layui-btn-btnEdit layui-btn-xs btnAudit\" lay-event=\"audit\" title=\"" + text + "\"><i class=\"layui-icon\">\uE642</i>" + text + "</a>")
}
func Detail(text string) template.HTML {
	return template.HTML("<a class=\"layui-btn layui-btn-btnEdit layui-btn-xs btnDetail\" lay-event=\"detail\" title=\"" + text + "\"><i class=\"layui-icon\">\uE642</i>" + text + "</a>")
}
...
func ChainUpload(text string) template.HTML {
	return template.HTML("<a class=\"layui-btn layui-btn-btnEdit layui-btn-xs btnChainUpload\" lay-event=\"chain_upload\" title=\"" + text + "\"><i class=\"layui-icon\">\uE642</i>" + text + "</a>")
}
func Outstock(text string) template.HTML {
	return template.HTML("<a class=\"layui-btn layui-btn-btnEdit layui-btn-xs btnoutstock\" lay-event=\"outstock\" title=\"" + text + "\"><i class=\"layui-icon\">\uE642</i>" + text + "</a>")
}
