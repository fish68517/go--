...
func (d *Dao) GetAdminUserWithRole(ctx context.Context, adminUser *model.AdminUserWithRole) (*model.AdminUserWithRole, error) {
	return adminUser.GetUserRoleView(ctx, d.engine)
}
